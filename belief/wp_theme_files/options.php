...
if ( function_exists('optionsframework_init') ) {
	...
	function optionsframework_option_name() {
		...
		$optionsframework_settings = get_option(BELIEF_THEME_SLUG.'_theme_inputs_options');
		$optionsframework_settings['id'] = BELIEF_THEME_SLUG.'_theme_inputs_options';
	...
	function optionsframework_options() {
		...
		$options[] = array(
			...
			'type' => 'heading' );
		$options[] = array(
			'name' => __('Analytics ID'),
			'desc' => __('Your Analytics Property ID: UA-XXXXXXXX-X'),
			'id' => 'ga_tracking_id',
			'std' => '',
			'type' => 'text');
		$options[] = array(
			'name' => __('Tag Manager Snippet'),
			'desc' => __('Overwrites GA Code! Provide full gtm snippet here.'),
			'id' => 'gtm_tracking',
			'std' => '',
			'type' => 'textarea');
	...
	/**
	 *	framework options templates
	 * 
	 * @return listed options
	 */
	function optionsframework_templates_options() {
		// Test data
		$test_array = array(
